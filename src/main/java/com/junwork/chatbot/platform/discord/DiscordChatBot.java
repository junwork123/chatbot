...
import com.junwork.chatbot.platform.discord.EventSensor.DiscordMessageEventSensor;
import com.junwork.chatbot.platform.discord.EventSensor.DiscordVoiceEventSensor;
...
public class DiscordChatBot implements ChatBot {
    ...
    @Override
    public ApiResult.ApiEntity<?> execute(ChatDto requestDto) {
